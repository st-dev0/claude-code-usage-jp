...
![サマリーカード・インフォバー](screenshots/overview.png)

![日別チャート・モデル別トークン使用量](screenshots/charts.png)

![モデル別割合・時間帯別アクティビティ・プロジェクト別集計](screenshots/analytics.png)
...
| 活用Tips | Claude Codeの便利な使い方をランダム表示 |
...
```bash
git clone https://github.com/fyve-inc/claude-code-usage-jp.git
...
`~/.claude/tools/usage-dashboard/tips.json` を編集すると、ダッシュボードに表示されるTipsを変更できます。
